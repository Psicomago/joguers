...
class ProvincesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create province" do
    assert_difference("Province.count") do
      post provinces_url, params: { province: { province_code: @province.province_code, province_name: @province.province_name } }
    end
  ...
  test "should update province" do
    patch province_url(@province), params: { province: { province_code: @province.province_code, province_name: @province.province_name } }
